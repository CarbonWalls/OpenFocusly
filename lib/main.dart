...
class Store extends ChangeNotifier {
  ...
  Future<void> syncNotesFolder(String folderName, String treeUri) async {
    ...
    for (final list in notes.values) {
      for (final n in list) {
        if (n.uri.isNotEmpty) knownUris.add(n.uri);
      }
    }
    var changed = false;
  ...
  void deleteNoteById(String id) {
    for (final list in notes.values) list.removeWhere((e) => e.id == id);
    touch();
  }
}
...
class Pal {
  ...
  // Compatibility accessor used by ThemeScope.of(context).pal.
  Pal get pal => this;
          ...
          Row(
            ...
            children: [
              Btn(
                ...
                child: Text(
                  L.t('cancel'),
                  style: body(p, w: FontWeight.w600),
                ),
              ),
          ...
          Padding(
              ...
              child: Row(children: [
                Container(
                    ...
                    child: Center(
                        child: IconX('bolt', size: 18, color: p.accent))),
              ...
              children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          Text(
                            'A calm place to track, focus and reflect.',
                            style: body(p),
                          ),
                        ],
                      ),
                ...
                LayoutBuilder(
                  builder: (_, constraints) {
                    ...
                    final twoColumns = w >= 430;
                    final tileWidth = twoColumns ? (w - 10) / 2 : w;
                ...
                _Quick(
                  ...
                  sub: 'Track a number with one tap.',
                  on: () => nav.go(1),
                ),
                ...
                _Quick(
                  ...
                  sub: 'Review the day and your events.',
                  on: () => nav.go(2, tab: 0),
                ),
                const SizedBox(height: 9),
                _Quick(
                  icon: 'note',
                  titleText: L.t('notes'),
                  sub: 'Keep ideas and reminders nearby.',
                  on: () => nav.go(3),
                ),
              ],
            ),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 3),
                  Text(
                    'Start a calm 25 minute session.',
                    style: cap(p),
                  ),
                ],
              ),
...
class _CountersState extends State<CountersScreen> {
  ...
  List<Counter> get list {
    ...
    final out = store.counters.where((c) {
      final folderMatch = folder.isEmpty || c.group == folder;
  ...
  void openEditor([Counter? counter]) {
    ...
    await sheet<void>(
      ...
      Column(
        ...
        children: [
          ...
          Text(
            'le cartelle vengono ricavate automaticamente dai tuoi contatori.',
  ...
  Future<void> deleteCounter(Counter c) async {
        ...
        return Column(
          children: [
            Header(
              ...
              sub: '${l.length} ${l.length == 1 ? 'item' : 'items'}',
              back: true,
              actions: [
                IconBtn(icon: 'folder', on: chooseFolder),
                IconBtn(icon: 'plus', on: () => openEditor()),
              ],
            ),
            Padding(
                      ...
                      child: Padding(
                        ...
                        child:
                          ...
                          Container(
                            ...
                            child: Center(
                                child: IconX('tag', size: 24, color: p.accent)),
                          ),
                          const SizedBox(height: 13),
                          Text(L.t('noCounters'), style: title(p, s: 17)),
                          const SizedBox(height: 5),
                          Text(
                              'crea un contatore e tienilo a portata di un tap.',
                              style: cap(p),
...
class _CounterDetailState extends State<CounterDetailScreen> {
  ...
  Future<void> _setScreenOn(bool enabled) async {
    try {
      await Store.channel.invokeMethod('setKeepScreenOn', {'enabled': enabled});
    } catch (_) {}
  }

  Future<void> _setFullscreen(bool enabled) async {
    try {
      await Store.channel.invokeMethod('setFullscreen', {'enabled': enabled});
    } catch (_) {}
  }
  ...
  void _toggleStopwatch() {
    setState(() {
      ...
      if (stopwatch) {
        ...
        watchTimer?.cancel();
        watchTimer = Timer.periodic(const Duration(seconds: 1), (_) {
  ...
  Future<void> _options() async {
    ...
    await sheet<void>(
        ...
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text('opzioni', style: title(p, s: 19)),
          const SizedBox(height: 8),
          _MenuAction(
              icon: 'bolt',
              label: 'mantieni schermo acceso',
              onTap: () {
                Navigator.pop(context);
          ...
          _MenuAction(
              icon: 'clock',
              label: stopwatch ? 'ferma cronometro' : 'cronometro',
              onTap: () {
                Navigator.pop(context);
                _toggleStopwatch();
              }),
          _MenuAction(
              icon: 'target',
              label: vibration ? 'vibrazione attiva' : 'vibrazione disattiva',
              onTap: () {
                Navigator.pop(context);
          ...
          _MenuAction(
              icon: 'play',
              label: sound ? 'suono attivo' : 'suono disattivo',
              onTap: () {
                Navigator.pop(context);
          ...
          _MenuAction(
              icon: 'plus',
              label: volumeButtons ? 'tasti volume attivi' : 'usa tasti volume',
              onTap: () {
                Navigator.pop(context);
...
class _CounterEditorState extends State<CounterEditorScreen> {
  ...
  late final TextEditingController mult;
  late final TextEditingController moneyValue;
  late final TextEditingController moneyStep;
  late final TextEditingController goalV;
  late final TextEditingController goalM;
  String folder = '';
  ...
  void initState() {
    ...
    mult.addListener(_moneyVisibilityChanged);
  }

  void _moneyVisibilityChanged() {
  ...
  @override
  void dispose() {
    mult.removeListener(_moneyVisibilityChanged);
    for (final c in [
      name,
      value,
      step,
    ...
    return ListView(
      ...
      children: [
        Header(
          ...
          sub: 'uno spazio dedicato, senza popup',
          back: true,
          actions: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(11),
                        border:
                            Border.all(color: manualMoney ? p.accent : p.line)),
                    child: Row(children: [
                      IconX(manualMoney ? 'check' : 'tag',
                          size: 16, color: manualMoney ? p.accent : p.text2),
                      const SizedBox(width: 8),
                      Expanded(
                        ...
                        Expanded(
                          child: Btn(
                            ...
                            child: Text(
                              ...
                              textAlign: TextAlign.center,
                              style: TextStyle(
                                  color: goalAction == option ? white : p.text2,
                                  fontSize: 11,
                                  fontWeight: FontWeight.w800),
                            ),
                          ),
...
class _CounterButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Btn(
      filled: primary,
      on: onTap,
      pad: const EdgeInsets.symmetric(vertical: 11),
      child: Row(
    ...
    return Column(
      children: [
        Header(
          ...
          sub: focus
              ? 'A quiet session, one minute at a time.'
              : 'Notes and events by day.',
          back: true,
          actions: [
            IconBtn(
              icon: 'settings',
                      ...
                      for (final minutes in <int>[
                        ...
                        Btn(
                          ...
                          child: Text(
                            '$minutes ${L.t('minutes')}',
                            style: TextStyle(
                              color: duration == minutes * 60 ? white : p.text2,
                              fontWeight: FontWeight.w700,
                              fontSize: 11,
                            ),
                          ),
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Expanded(
              child: Text(
                name.isEmpty ? 'senza titolo' : name,
                maxLines: 2,
                overflow: TextOverflow.ellipsis,
                style: TextStyle(
                  color: p.text,
                    ...
                    children: [
                      Row(
                        children: [
                          Expanded(
                            child: Text(
                              '${labels[widget.month.month - 1]} ${widget.month.year}',
                              style: TextStyle(
                                color: p.text,
                                fontSize: 16,
                                fontWeight: FontWeight.w800,
                      ...
                      Row(
                        children: [
                          Expanded(
                            child: Text(
                              query.isEmpty
                                  ? '${widget.selected.day} ${labels[widget.selected.month - 1]}'
                                  : 'Search results',
                              style: TextStyle(
                                color: p.text,
                                fontWeight: FontWeight.w800,
                        ...
                        Padding(
                          ...
                          child: Dismissible(
                            ...
                            background: _SwipeNoteBg(
                              icon: 'pin',
                              label: note.pinned ? 'sblocca' : 'fissa',
                              alignment: Alignment.centerLeft,
                            ),
                            secondaryBackground: const _SwipeNoteBg(
                              icon: 'trash',
                              label: 'elimina',
                              alignment: Alignment.centerRight,
                              danger: true,
...
class _NotesState extends State<NotesScreen> {
  ...
  String trimName(String s, {int max = 30}) {
    final clean = s.trim().replaceAll(RegExp(r'\s+'), ' ');
    if (clean.length <= max) return clean;
    final cut = clean.substring(0, max - 1);
    final lastSpace = cut.lastIndexOf(' ');
    return '${(lastSpace > max * .55 ? cut.substring(0, lastSpace) : cut).trim()}…';
  }

  Future<void> chooseFolder({bool requiredForCreate = false}) async {
    try {
      final result = await store.pickNotesFolder();
      ...
      await sheet<void>(
        ...
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('accesso cartella',
                style: title(ThemeScope.of(context).pal, s: 19)),
            const SizedBox(height: 8),
            Text(e.message ?? 'impossibile aprire il selettore delle cartelle.',
                style: body(ThemeScope.of(context).pal)),
            const SizedBox(height: 14),
            Btn(
              filled: true,
  ...
  Future<void> ensureFolderAndCreate() async {
    if (store.prefs.notesFolderUri.trim().isEmpty) {
      await chooseFolder(requiredForCreate: true);
  ...
  Future<void> importMarkdown() async {
    try {
      ...
      for (final block in blocks) {
        ...
        int divider = bodyLines.indexWhere((e) => e.trim() == '---');
        ...
        if (imported.isNotEmpty) n = imported.first;
        if (n != null) n.pinned = pinned;
      }
      store.touch();
    } catch (_) {}
  }
  ...
  Future<void> noteMenu(Note n) async {
    await showNoteMenu(context, n);
  }

  Future<void> showProperties(Note n) async {
    await showNoteProperties(context, n);
  }
                        ...
                        children: [
                          ...
                          Text(
                            store.prefs.notesFolderUri.isEmpty
                                ? 'seleziona una cartella per iniziare'
                                : 'nessuna nota',
                            style: cap(p),
                            textAlign: TextAlign.center,
                          ),
...
Future<void> showNoteProperties(BuildContext context, Note n) async {
  final p = ThemeScope.of(context).pal;
  final name = n.name.isEmpty ? 'senza titolo' : n.name;
  ...
  await sheet<void>(
      context,
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text('proprietà', style: title(p, s: 20)),
        const SizedBox(height: 14),
        _PropertyRow('nome', name),
        _PropertyRow('cartella', safeFolder),
        _PropertyRow('dimensione', _formatBytes(bytes)),
        _PropertyRow('percorso / uri', path),
        _PropertyRow('modificata', _formatNoteDate(n.ts)),
        const SizedBox(height: 10),
        Btn(
            filled: true,
            on: () => Navigator.pop(context),
...
class _NoteEditorState extends State<NoteEditorScreen> {
  ...
  Future<void> options() async {
    ...
    await sheet<void>(
      context,
      Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Text('opzioni nota', style: title(p, s: 20)),
        const SizedBox(height: 10),
        _MenuAction(
            icon: 'pin',
            label: widget.note?.pinned == true ? 'sblocca' : 'fissa',
            onTap: () {
              if (widget.note != null) {
        ...
        _MenuAction(
            icon: 'folder',
            label: 'cartella: ${folder.isEmpty ? 'seleziona' : folder}',
            onTap: () {
              Navigator.pop(context);
              pickFolder();
            }),
        ...
        _MenuAction(
            icon: 'note',
            label: preview ? 'modifica markdown' : 'anteprima markdown',
            onTap: () {
              Navigator.pop(context);
  ...
  Future<void> showProperties(Note n) async {
    ...
    final safeFolder =
        n.folder.trim().isEmpty ? 'selezionata' : n.folder.trim();
...
class MarkdownPreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (final raw in lines) {
      ...
      final fence = line.trim().startsWith('```');
      ...
      if (fence) {
        children.add(Container(
            ...
            child: Text(line,
                style: TextStyle(
                    color: p.sub, fontFamily: 'monospace', fontSize: 12))));
        continue;
      }
...
class LiveMarkdownController extends TextEditingController {
  ...
  bool _nearRange(int position, int start, int end, {int distance = 2}) {
    return position >= start - distance && position <= end + distance;
  }
  ...
  List<InlineSpan> _renderInline(
    ...
    for (final m in matches) {
      ...
      final token = m.group(0)!;
      final absoluteStart = lineStart + m.start;
      final absoluteEnd = lineStart + m.end;
      final selectionStart = selection.start;
      final selectionEnd = selection.end;
      final active = selectionStart >= 0 &&
          selectionEnd >= 0 &&
          (selectionStart == selectionEnd
              ? _nearRange(selectionStart, absoluteStart, absoluteEnd)
              : selectionStart <= absoluteEnd && selectionEnd >= absoluteStart);
      ...
      if (token.startsWith('**')) {
        ...
        contentStyle = base.copyWith(decoration: TextDecoration.underline);
      } else {
        marker = '*';
        content = token.substring(1, token.length - 1);
      ...
      if (marker.isNotEmpty && !token.startsWith('`')) {
        spans.add(
            TextSpan(text: marker, style: _markerStyle(base, visible: active)));
      } else if (token.startsWith('`')) {
        spans.add(
        ...
        if (closeParen > close && closeParen > 0) {
  ...
  TextSpan buildTextSpan(
    ...
    for (var i = 0; i < lines.length; i++) {
      ...
      if (line.trim().startsWith('```')) {
        ...
        spans.add(TextSpan(
            text: opening, style: _markerStyle(base, visible: revealOpening)));
        spans.add(TextSpan(
...
class SettingsScreen extends StatelessWidget {
  ...
  Future<void> goals(BuildContext context) async {
    final p = ThemeScope.of(context).pal;
    final existingV = store.prefs.goalV;
    final existingM = store.prefs.goalM;

    final valueCtrl = TextEditingController(
      text: existingV == null ? '' : fmt(existingV),
    );

    final moneyCtrl = TextEditingController(
      text: existingM == null ? '' : fmt(existingM),
    );
  ...
  Future<void> backup() async {
    try {
      ...
      await Store.channel.invokeMethod(
        'write',
        {
          'uri': uri,
          'bytes': Uint8List.fromList(
            utf8.encode(jsonEncode(store.toJson())),
          ),
        },
      );
    } catch (_) {}
  ...
  Future<void> restore() async {
    try {
      ...
      final bytes = await Store.channel.invokeMethod<Uint8List>(
        'read',
        {
          'uri': uri,
        },
        ...
        return ListView(
          ...
          children: [
            Header(
              ...
              sub: 'Make the app feel like yours.',
              back: true,
            ),
            _SetCard(
              'Appearance',
            ...
            _SetCard(
              ...
              [
                _SetAction(
                  'info',
                  L.t('info'),
                  'Built with Flutter widgets.dart.',
                  () => nav.go(5),
                ),
              ],
            ),
          ...
          Center(
              child: Container(
                  ...
                  child: Column(children: [
                    ...
                    const SizedBox(height: 5),
                    Text('Custom widgets.dart interface', style: cap(p)),
                    const SizedBox(height: 14),
                    Text(
...
class _RootState extends State<Root> {
  ...
  Widget page() {
    switch (nav.screen) {
      ...
      case 8:
        return CounterDetailScreen(counter: nav.viewingCounter!);
      default:
